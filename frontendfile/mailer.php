<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        try {
            ...
            $mail->Password   = 'imrane@CHAIBI123';                               //SMTP password
            ...
            $mail->addAddress('imranchaibi1@gmail.com');     //Add a recipient
            ...
            $Err = '<div class="alert alert-danger">First name can not be blank.</div>';
        }
    }